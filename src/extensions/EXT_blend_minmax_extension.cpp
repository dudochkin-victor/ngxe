...
bool EXT_blend_minmax_supported=false;

bool SetUpEXT_blend_minmax()
{
	//Check for support
	char * extensionString=(char *)glGetString(GL_EXTENSIONS);
	char * extensionName="GL_EXT_blend_minmax";
	...
	while(extensionString<endOfString)
	{
		...
		{
			EXT_blend_minmax_supported=true;
		}
	...
	if(!EXT_blend_minmax_supported)
	{
		errorLog.OutputError("EXT_blend_minmax unsupported!");
		return false;
	}

	errorLog.OutputSuccess("EXT_blend_minmax supported!");
