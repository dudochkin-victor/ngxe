...
void CreateMyWindow(const char * strWindowName, int width, int height, int VideoFlags)
{
    ...
    SDL_WM_SetCaption(strWindowName, "www.spacesimulator.net - 3d engine tutorials: Tutorial 2");  
}
...
int main(void)
{
    ...
    SetupPixelFormat();    
    CreateMyWindow("www.spacesimulator.net - 3d engine tutorials: Tutorial 2", SCREEN_WIDTH, SCREEN_HEIGHT, VideoFlags);
