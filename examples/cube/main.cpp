...
int Curr_TexMode = 0;
char *TexModesStr[] = { (char*) "GL_DECAL", (char*) "GL_MODULATE",
		(char*) "GL_BLEND", (char*) "GL_REPLACE" };
...
int main(int argc, char **argv) {
	...
	v->onDraw(&cbRenderScene);

	// If there's nothing to do, draw.
	v->onIdle(&cbRenderScene);
