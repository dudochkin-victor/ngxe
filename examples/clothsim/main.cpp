...
//////////////////////////////////////////////////////////////////////////////////////////	
#include "View.h"
//#include "GL_files/GLee.h"	//header for opengl versions >1.1 and extensions
#include <GL/glu.h>
...
bool GLInit()
{
	...
	//{
		//Util::log("I require OpenGL 1.4 support");
		//return false;
	//}
...
bool DemoInit()
{
	...
	{
		Util::log("Unable to allocate space for balls & springs");
		return false;
	}
	...
	//Load floor texture
	IMAGE floorImage;
	if(!floorImage.Load("../data/texture/floor.tga"))
		return false;
...
int main(int argc, char **argv) {
	...
	// Open a window
	v->createWindow("cloth simulation", 640, 480);
